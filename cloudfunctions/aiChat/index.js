...
exports.main = async (event, context) => {
  ...
  try {
    const { message, imageUrl = '', history = [] } = event  // 从前端接收历史记录
    ...
    // 🔒 隐私保护：不再保存消息到数据库
    // await saveMessage(openid, 'user', message, imageUrl)  // 已移除
